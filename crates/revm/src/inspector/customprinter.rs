...
impl<T: From<Box<dyn Any>>, DB: Database> Inspector<T, DB> for CustomPrintTracer {
    fn initialize_interp(&mut self, interp: &mut Interpreter, context: &mut EvmContext<DB>) {
        <GasInspector as Inspector<T, DB>>::initialize_interp(
...
mod test {
    ...
    fn gas_calculation_underflow() {
        ...
        let mut evm = Evm::<Box<dyn Any>, (), EmptyDBTyped<Infallible>>::builder()
            ...
            .modify_db(|db| {
                let code: revm_precompile::Bytes = bytes!("");
